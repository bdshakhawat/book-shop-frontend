...
const Contact = () => {
  return (
    <section id="contact" className="w-full min-h-screen py-16 px-6 bg-white dark:bg-gray-900 text-gray-800 dark:text-white">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col justify-center text-center md:text-left">
            ...
            <div className="text-gray-700 dark:text-gray-200">
              <p>Email: <a href="mailto:support@tutorlink.com" className="underline">support@bookshop.com</a></p>
